...
func (g *MockCargoClient) ListVersions(ctx context.Context, crate string) ([]string, error) { //nolint:revive
...
func (g *MockCargoClient) GetLatestVersion(ctx context.Context, crate string) (string, error) { //nolint:revive
	versions, ok := g.versions[crate]
	if !ok {
