...
`,
	...
	for _, d := range data {
		...
		t.Run(d.name, func(t *testing.T) {
			...
			pipClient := &pip.MockClient{}
			ctrl := generate.New(configFinder, configReader, registryInstaller, gh, fs, fuzzyFinder, versionSelector, cargoClient, crateVersionSelector, pipClient)
