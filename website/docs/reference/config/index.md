...
* `AQUA_DISABLE_VACUUM`: If true, [Vacuum](/docs/guides/vacuum#disable-vacuum) is disabled. aqua doesn't record packages' last used date times and the `aqua vacuum` command fails (aqua >= v2.63.0)
